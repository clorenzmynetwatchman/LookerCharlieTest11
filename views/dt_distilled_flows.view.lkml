...
view: dt_distilled_flows {
  ...
  derived_table: {
    sql: SELECT
        ...
        ,actor_id
        {% endif %}
        {% if customer._in_query or customer_peer._in_query or explore._name contains "external" %}
        ,customer_id
        {% endif %}
       ...
       FROM {% if actor._in_query
                ...
                and host._in_query
                and customer._in_query or customer_peer._in_query or explore._name contains "external" %}
           ...
           {% elsif
            ...
            {% elsif
                customer._in_query or customer_peer._in_query or explore._name contains "external" %}
